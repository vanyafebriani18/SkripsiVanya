...
def main() -> None:
    ...
    with tabs[2]:
        ...
        fig_scatter = px.scatter(
            ...
            y=y_feature,
            color="Nama_Segmen",
            hover_data=[c for c in ["Customer_ID", "Usia", "Jenis_Pekerjaan"] if c in result_df.columns],
            title=f"Visualisasi Cluster: {DISPLAY_NAMES[x_feature]} dan {DISPLAY_NAMES[y_feature]}",
        )
